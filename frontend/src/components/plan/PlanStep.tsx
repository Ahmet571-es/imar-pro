              ...
              <button key={i} onClick={() => setSelectedPlanIndex(i)}
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={cn(
                    ...
                    plan.source === 'claude' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700',
                  )}>
                    {plan.source}
                  </span>
                </div>
                ...
                {activePlan.cross_review_notes && (
                  <div className="bg-white rounded-xl border border-border p-4">
                    ...
                    <div className="text-xs text-text-muted mb-1">
                      Puan: <span className="font-bold text-primary">{activePlan.cross_review_score.toFixed(0)}/100</span>
                    </div>
                    <p className="text-xs text-text-muted leading-relaxed">{activePlan.cross_review_notes}</p>
                  </div>
                )}
