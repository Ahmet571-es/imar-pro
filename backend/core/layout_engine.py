...
class PlacedRoom:
    ...
    def is_on_edge(self, bw: float, bh: float, ox: float = 0, oy: float = 0, tol: float = 0.15) -> bool:
    ...
    def facing_direction(self, bw: float, bh: float, ox: float = 0, oy: float = 0, tol: float = 0.15) -> str:
